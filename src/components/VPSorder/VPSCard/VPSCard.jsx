...
export const VPSCard = ({ data }) => {
    ...
    return (
        <div className={classNames("VPS_card", { "ssd": data.category === "nvme", "hdd": data.category === "hdd", "turbo": data.category === "turbo" })}>
            <div className="flexCard">
                <div className="top">
                    <div className="top__img">
                        <img src={data.category === "nvme" ? ssd_icon : data.category === "hdd" ? hdd_icon : turbo_icon} alt="icon" />
                    </div>
                ...
                <div className="params">
                    <div className="stats">
                        ...
                        <span className="stats__param">{data.cpu_cores} x {(data.category_id === "1" && <label>2,8</label>) || (data.category_id === "2" && <label>2,1</label>) || (data.category_id === "3" && <label>5</label>)} ГГц</span>
                    </div>
                    <div className="stats">
                    ...
                    <div className="stats">
                        <span className="stats__title">CPU</span>
                        <span className="stats__param">{data.volume_disk} {data.disk_type}</span>
                    </div>
                </div>
                ...
                <div className={classNames("additional_desc", {"additional_desc_one": data.category_id === "2" })}>
